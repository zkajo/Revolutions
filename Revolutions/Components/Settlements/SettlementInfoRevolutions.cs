...
namespace Revolutions.Components.Settlements
{
    ...
    public class SettlementInfoRevolutions : SettlementInfo
    {
        ...
        public bool IsLoyalFactionOfImperialCulture => RevolutionsManagers.FactionManager.GetGameObject(this.LoyalFactionId).Culture.Name.ToString().ToLower().Contains("empire");
